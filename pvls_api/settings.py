"""
Django settings for pvls_api project.
...
WSGI_APPLICATION = 'pvls_api.wsgi.application'

CORS_ALLOWED_ORIGINS = [
    env('ALLOWED_ORIGIN_LOCAL'),
    env('ALLOWED_ORIGIN_SHOW'),
]
